...
if pos.z < -40:
    mc.postToChat("Teleporting you to a safer distance!")
    mc.player.setPosition(pos.x, pos.y, -40)
    pos = mc.player.getTilePos()
...
mc.setBlocks(
    pos.x - 1, pos.y + 3, pos.z,
    pos.x + 1, pos.y - 7, pos.z - 88,
    block.AIR.id)
...
mc.setBlocks(
    pos.x, pos.y - 1, pos.z - 88,
    pos.x - 1, pos.y - 7, pos.z - 88,
    block.BEDROCK_INVISIBLE.id)

mc.setBlocks(
    pos.x - 1, pos.y - 1, pos.z - 88,
    pos.x, pos.y - 7, pos.z - 88,
    block.BEDROCK_INVISIBLE.id)
mc.setBlocks(
    pos.x, pos.y - 1, pos.z,
    pos.x, pos.y - 7, pos.z,
